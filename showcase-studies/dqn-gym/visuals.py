...
class Visuals:
    def __init__(self, actions):
        ...
        all_action_names = ['no-op', 'fire', 'up', 'right', 'left', 'down',
                            'up_right', 'up_left', 'down-right', 'down-left',
                            'up-fire', 'right-fire', 'left-fire', 'down-fire',
                            'up-right-fire', 'up-left-fire', 'down-right-fire',
                            'down-left-fire']
        ...
        xlocations = np.linspace(0.5, self.num_actions - 0.5,
        ...
        if self.num_actions > 7:
            ...
            self.fig = plt.figure()
        self.bars = plt.bar(np.arange(self.num_actions),
                            np.zeros(self.num_actions), 0.9)
