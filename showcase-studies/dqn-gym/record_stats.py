    ...
    def record(self, epoch):
        ...
        if not self.test:
            ...
            summary_str = self.sess.run(self.summary_op,
                                        feed_dict={self.spg: score_per_game,
                                                   self.mean_l: avg_loss,
                                                   self.mean_q: mean_q_values,
                                                   self.total_gp: steps_per_game,
                                                   self.max_r: self.max_score,
                                                   self.min_r: self.min_score,
                                                   self.time: step_per_sec})
