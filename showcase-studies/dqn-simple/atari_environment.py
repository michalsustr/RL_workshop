...
class AtariEnvironment:
    ...
    def __init__(self, args, outputDir):
        ...
        # Load the ROM file
        self.ale.loadROM(args.rom.encode('UTF-8'))
        ...
        for i in range(4):
            ...
            if self.gameNumber % self.screenCaptureFrequency == 0:
                ...
                if not os.path.isdir(dir):
                    logging.info("Capturing screen this iteration into "+self.outputDir + '/screen_cap/')
                    os.makedirs(dir)
                self.ale.saveScreenPNG((dir + '/frame-%06d.png' % (self.getEpisodeFrameNumber())).encode('UTF-8'))
